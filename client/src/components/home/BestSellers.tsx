      ...
      <div className="container-custom">
        <div className="flex flex-col md:flex-row justify-between items-end gap-12 mb-32">
          <div className="max-w-xl">
            ...
            <h2 className="heading-large mb-8">The Best Sellers</h2>
          ...
          <Link href="/shop" className="btn-outline-premium group">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 lg:gap-24">
          {products.map((product, i) => (
            ...
            >
              <div className="relative aspect-[3/4] rounded-[4rem] overflow-hidden bg-warm-gray mb-10 shadow-premium">
                <img 
                ...
                {/* Actions */}
                <div className="absolute bottom-10 left-10 right-10 flex gap-4 translate-y-6 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-700">
                  <button 
                    onClick={() => addItem(product.id)}
                    className="flex-1 bg-white text-charcoal py-5 rounded-3xl text-[10px] uppercase tracking-widest font-bold flex items-center justify-center gap-3 hover:bg-gold hover:text-white transition-all shadow-2xl"
                  >
